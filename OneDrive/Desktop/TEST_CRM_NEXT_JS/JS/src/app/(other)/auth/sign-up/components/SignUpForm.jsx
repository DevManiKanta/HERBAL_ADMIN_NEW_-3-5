...
const SignUpForm = () => {
  ...
  const onSubmit = async (values) => {
    // call context signUp; context will show notifications & optionally auto-login
    const res = await signUp(values, { autoLogin: true, redirect: '/dashboard' });

    if (res?.ok) {
      // already redirected if redirect provided to signUp; otherwise handle here
      // e.g., push('/dashboard') or show extra UI
    } else {
